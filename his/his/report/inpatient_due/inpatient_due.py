...
class AccountReceivableSummary(ReceivablePayableReport):
	...
	def get_data(self, args):
		...
		for party, party_dict in iteritems(self.party_total):
			...
			if customer in inpatient:
				...
				row.receipt	  =f"""<button style='padding: 3px; margin:-5px' class= 'btn btn-primary' onClick='receipt("{party}")'>Receipt</button>"""
	...
	def get_columns(self):
		...
		self.add_column(_("Room"), fieldname="room", fieldtype="Data")
		self.add_column(_("Bed"), fieldname="bed", fieldtype="Data")
